 ...
 * This script manages the cookie consent banner, allowing users to accept or reject cookies.
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelector('#cookie-banner .accept').addEventListener('click', function() {
      ...
      // Aquí puedes inicializar scripts de cookies si el usuario acepta
    });

    document.querySelector('#cookie-banner .reject').addEventListener('click', function() {
      localStorage.setItem('cookiesConsent', 'rejected');
      cookieBanner.style.display = 'none';
      // Aquí puedes bloquear scripts que requieran consentimiento
    });
  });